...
class EventsLogger {
   public:
    enum EventCode { discovery, late_message, too_late_message, lost_messages };
    ...
    EventsLogger(std::string filename) {
        ...
        if (!_file.is_open()) {
            std::cout << "[EventsLogger]: Error. Could not open file "
                      << _filename << std::endl;
        ...
        _file << std::left << std::setw(_p_time_width)
              << std::setfill(_p_separator) << "Time[ms]";
        _file << std::left << std::setw(_p_caller_name_width)
              << std::setfill(_p_separator) << "Caller";
        _file << std::left << std::setw(_p_code_width)
              << std::setfill(_p_separator) << "Code";
        _file << std::left << std::setw(_p_desc_width)
              << std::setfill(_p_separator) << "Description" << std::endl;
    };
    ...
    void write_event(Event event) {
        ...
        _file << std::left << std::setw(_p_time_width)
              << std::setfill(_p_separator) << event_timestamp_ms;
        _file << std::left << std::setw(_p_caller_name_width)
              << std::setfill(_p_separator) << event.caller_name;
        _file << std::left << std::setw(_p_code_width)
              << std::setfill(_p_separator) << event.code;
        _file << std::left << std::setw(_p_desc_width)
              << std::setfill(_p_separator) << event.description << std::endl;
    }
