...
def get_sub_factory(msgs, package):
  ...
  for msg_name in msgs:
    ...
    topic = "performance_test::Topic<" + msg_class_name + ">(sub_topic_name),performance_test::Topic<" + msg_class_name + ">(pub_topic_name)"
...
def get_non_periodic_pub_factory(msgs, package):
  ...
  extern "C" void add_non_periodic_publisher_impl(
    std::shared_ptr<performance_test::Node> n,
    std::string msg_type,
    std::string sub_topic_name,
    std::string pub_topic_name,
  ...
  function = "add_non_periodic_publisher"
  user_args = "msg_pass_by, custom_qos_profile, msg_size"
...
def main():
  ...
  content += get_non_periodic_pub_factory(msgs, package)
